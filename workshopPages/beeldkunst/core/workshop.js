        ...
        success: function(data){
            ...
            if(ws1 == 'postdrukkerij'){
                function workshop16(){
                    ...
                    $("#location").html(data[16].location);
...
$(window).ready(function(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            // click functions for information about workshops
            $("#pol0").click(function animatie(){
                $("#workshopTitle").html(data[0].title);
                $("#intro").html(data[0].intro);
                $("#about").html(data[0].about);
                $("#goals").html(data[0].goals);
